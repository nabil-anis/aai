...
export const MortarBoardIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const PanelOpenIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const GraduationCapIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.084a1 1 0 0 0 0 1.838l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>
);
...
export const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2.34a6.29 6.29 0 0 1-.28 1.9Z"/><path d="M12 18a7 7 0 0 0 7-7V4a2 2 0 0 0-2-2h-1"/></svg>
);

export const PaletteIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.103-.822-.283-1.177-.19-.37-.434-.712-.73-1.01-.294-.298-.63-.532-1.01-.73-.355-.18-.753-.283-1.177-.283-1.8 0-3.268 1.468-3.268 3.268 0 .925.742 1.667 1.667 1.667h5.333c5.5 0 10-4.5 10-10S17.5 2 12 2z"/></svg>
);
...
export const AtomIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="1"/><path d="M20.2 20.2c2.04-2.03.02-5.91-2.98-8.9-3-3-6.87-4.99-8.9-2.98"/><path d="M3.8 3.8c-2.04 2.03-.02 5.91 2.98 8.9 3 3 6.87 4.99 8.9 2.98"/><path d="M3.8 20.2c-2.03-2.04 5.91-.02 8.9-2.98 3-3 4.99-6.87 2.98-8.9"/><path d="M20.2 3.8c2.03 2.04-5.91.02-8.9 2.98-3 3-4.99 6.87-2.98 8.9"/></svg>
);
